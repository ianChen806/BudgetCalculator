...
namespace BudgetCalculator
{
    ...
    public class UnitTest1
    {
        ...
        private Accounting _target;

        [TestInitialize]
        public void TestInit()
        {
            _target = new Accounting(_repository);
        }
        //
        // /// <summary>
        // /// 資料庫沒預算
        ...
        //
        //     Action actual = () => _target.TotalAmount(start, end);
        ...
        {
            _target.TotalAmount(new Period(start, end)).Should().Be(expected);
        }
    }
}